...
public class BadWordFilter {
   ...
   * contains the word *, bass should not be censored) then (in the String returned) replace the cuss word with asterisks.
   */
  public static String getCensoredText(final String input) {
    ...
    ArrayList<String> badWordsFound = new ArrayList<String>();
